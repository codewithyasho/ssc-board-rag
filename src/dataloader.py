...
from langchain_classic.document_loaders import PyMuPDFLoader, TextLoader, WebBaseLoader, UnstructuredWordDocumentLoader
...
# 3. load all word files in a directory UnstructuredWordDocumentLoader
def process_all_word_docs(directory):
    return process_files(directory, ".docx", UnstructuredWordDocumentLoader)


# 4. read all the web pages from a list of urls
...
# 5. load all the pptx files inside the directory
